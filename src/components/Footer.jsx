...
const Footer = () => {
  return (
    <div>
      <footer className="footer bg-gray-300 text-neutral-content items-center p-4 flex flex-wrap justify-between">
        ...
        <nav className="flex space-x-4 mt-4 md:mt-0">
          ...
          >
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current text-gray-600 hover:text-[#ff4c30]"
            >
